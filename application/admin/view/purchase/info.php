    ...
    <input type="hidden" name="cus_id" value="{$data.cus_id}"  id="cus_id" />
                    ...
                    <table class="table contact-template-form">
                               ...
                               <tr>
                                ...
                                </tr> 																<tr>                                    <td width="15%" class="right-color"><span>收货联系人:</span></td>                                    <td width="35%">                                        {$data.receiver}                                    </td>                                    <td width="15%" class="right-color"><span>收货人电话:</span></td>                                    <td width="35%">                                    {$data.receivernum}                                    </td>                                </tr> 
