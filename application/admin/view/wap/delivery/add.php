...
<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo url('add');?>" id="saveOrder" method="post">
    ...
    <div class="weui-cells weui-cells_form">
      ...
      <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" readonly="readonly" value="<?php echo date('Y-m-d');?>" name="delivery_date" id="delivery_date"/>
        </div>
      </div>
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd" style="position:relative;">
          <input class="weui-input" type="text" readonly="readonly" name="order_sn" id="order_sn" />
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="cus_name" id="cus_name" placeholder="输入送货公司"/>
        </div>
      </div>
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="delivery_address" id="delivery_address" placeholder="输入送货地址"/>
        </div>
      </div>
            <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="contacts_tel" id="contacts_tel" placeholder="输入收货电话"/>
        </div>
      </div>
