...
function goodsList(data){
	...
	html +='<span class="weui-form-preview__value goods_number"><input type="text" class="'+input_css+'" value="'+data[i]['current_send_number']+'" data-current_send_number="'+goods_info[i]['goods_number']+'" oninput="checkNum2(this)" name="current_send_number"/><span class="'+span_css+'">'+data[i]['current_send_number']+'</span><span style="float:right;">出库数量：'+data[i]['add_number']+'<span></span>';
	html +='</div>';
	html +='<div class="weui-form-preview__item" style="margin-bottom:10px;">';
