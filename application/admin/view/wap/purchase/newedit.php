...
<form class="form-horizontal" enctype="multipart/form-data" id="saveOrder" method="post">
    ...
    <div class="weui-cells weui-cells_form">
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd" style="position:relative;">
          ...
          <input class="weui-input" type="text" readonly="readonly" placeholder="请选择供应商"
                                {foreach name="$supplier" item="v"}
                                		 {if condition="$v['id'] eq $data['supplier_id']"}value="{$v.supplier_name}"{/if}
                                		{/foreach}
           name="select_supplier" id="select_supplier" />
        </div>
      </div>
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="contacts" value="{$data.contacts}" id="contacts" />
        </div>
      </div>
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="email" value="{$data.email}" id="email"/>
        </div>
      </div>
            <div class="weui-cell" >
        <div class="weui-cell__hd"><label class="weui-label">传真号码：</label></div>
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="fax" value="{$data.fax}" id="fax" />
        </div>
      </div>
            <div class="weui-cell" >
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="receiver" value="{$data['receiver']}" id="receiver" />
        </div>
      </div>
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="receivernum" value="{$data['receivernum']}" id="receivernum" />
        </div>
      </div>
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="transaction_type" placeholder="请选择交易类别" value="{$data['transaction_type']}" id="transaction_type" />
        </div>
      </div>
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="payment" placeholder="请选择付款条件" value="{$data['payment']}" id="payment" />
        </div>
      </div>
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="delivery_type" value="{$data['delivery_type']}" placeholder="请选择交货方式" id="delivery_type" />
        </div>
      </div>
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="tax" value="{$data['tax']}" placeholder="请选择税率" id="tax" />
        </div>
      </div>
    ...
    <div class="weui-cells">
      <div class="weui-cell">
        <div class="weui-cell__bd">
          <textarea class="weui-textarea" name="remark" style="height:150px;" placeholder="输入内容">{$data.remark}</textarea>
        </div>
      </div>
    </div>
    </div>
