...
<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo url('add');?>" id="saveOrder" method="post">
    ...
    <div class="weui-cells weui-cells_form">
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="contacts" placeholder="请输入联系人" id="contacts" />
        </div>
      </div>
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" value="" placeholder="请输入送货公司" name="delivery_company" id="delivery_company" />
        </div>
      </div>
      ...
      <div class="weui-cell" >
        ...
        <div class="weui-cell__bd" style="position:relative;">
          ...
          <input class="weui-input" type="text" placeholder="请输入送货地址" name="delivery_address" id="delivery_address" />
        </div>
      </div>
    ...
    <div class="weui-cells">
      <div class="weui-cell">
        <div class="weui-cell__bd">
          <textarea class="weui-textarea" name="remark" style="height:150px;" placeholder="输入内容">{$remark}</textarea>
        </div>
      </div>
    </div>
    </div>
