    ...
    <div class="weui-cells weui-cells_form">
      <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
          <input type="text" class="weui-input" readonly="readonly" value="{$store_sn}" name="store_sn" id="store_sn">
        </div>
      </div>
...
function goodsList(data){
	...
	for(var i in data){
		...
		html +='<span class="weui-form-preview__value input_store"><input type="text" class="price_input '+input_css+'" data-input_store="'+data[i]['purchase_input_store']+'" oninput="checkNum2(this)" value="'+data[i]['input_store']+'" name="input_store['+data[i]['goods_id']+']"/></span></span>';
		html +='</div>';
		html +='<div class="weui-form-preview__item" style="margin-bottom:10px;">';
