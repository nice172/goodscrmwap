    ...
    <div class="row">
        <div class="col-lg-12">
            <form class="form-horizontal" method="post" id="editUserForm">
                ...
                <div class="form-group">                    <label class="col-sm-2 control-label">性别</label>                    <div class="col-sm-10">                        <label class="mt-radio">                            <input type="radio" class="margin-right" name="con_sex" value="1" checked>男                        </label>                        <label class="mt-radio">                            <input type="radio" class="margin-right" name="con_sex" value="2">女                        </label>                    </div>                </div>
                <div class="form-group">
