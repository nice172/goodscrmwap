...
<!--                                         <span>单支的总长度</span> -->
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control w300" name="shop_price" id="shop_price" value="0" placeholder="输入采购价">
                                    </div>
                                </div>
                                                                <div class="form-group">
                                    <label for="market_price" class="col-sm-2 control-label"><span class="text-danger">*</span>销售价</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control w300" name="market_price" id="market_price" value="0" placeholder="输入销售价">
                                    </div>
                                </div>
                          <div class="form-group">
