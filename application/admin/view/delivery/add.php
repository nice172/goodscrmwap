  ...
  <div class="tab-content">
                    ...
                    <table class="table contact-template-form" style="margin-bottom: 10px;">
                                ...
                                <tr>
                                    ...
                                    <td width="35%">
                                        <input type="text" class="form-control w300" readonly="readonly" value="{$order_dn}" name="order_dn" id="order_dn">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td width="15%" class="right-color"><span class="text-danger">*</span><span>联系电话:</span></td>
                                    <td width="35%">
   ...
   // 	$('#contacts_tel').val(data.contacts_tel); 
	...
	$.get('<?php echo url('order');?>?purchase_id='+data.purchase_id,{},function(res){
		if(res.code == 1){
			...
			//$('#contacts_tel').val(res.data.contacts_tel);
