                    ...
                    <table class="table contact-template-form">
                               ...
                               <tr>
                                ...
                                <td width="35%" colspan="3">
                                	<input type="text" class="form-control w300" required="required" name="require_date" value="{$data.require_time|date='Y-m-d',###}" id="LAY-component-form-group-date">
                                </td>
                                </tr>
                                 <tr>
...
var goods_info = new Array();
    $(document).ready(function() {
		...
		//added by wei on 2018-9-30 begin
			...
			var con_id=($("#delivery_address").find("option:selected").attr("conid"));	
